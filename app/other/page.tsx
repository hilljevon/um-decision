...
import { CircleHelp, Hand, HelpCircle, HelpingHandIcon, HomeIcon, RotateCcw } from "lucide-react";
...
import CoveragesCard from "@/components/user/CoveragesCard";
        ...
        <>
            <header className="top-0 z-10 flex h-[57px] items-center gap-1 border-b bg-background px-4">
                <div className="flex justify-between w-full items-center">
                    <div>
                        <h1 className="text-xl font-semibold">Unconfirmed/Other Coverages</h1>
                    </div>
                    <div className="mr-8 flex justify-around space-x-4">
                        <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Link className=" inline-flex m-0 p-0" href={"/"}>
                                        <HomeIcon />
                                    </Link>
                                </TooltipTrigger>
                                <TooltipContent>
